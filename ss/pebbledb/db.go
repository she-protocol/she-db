...
import (
	...
	errorutils "github.com/she-protocol/she-db/common/errors"
	...
	"github.com/she-protocol/she-db/stream/changelog"
		...
		for entry := range ch {
			...
			if counter%ImportCommitBatchSize == 0 {
				...
				if counter%1000000 == 0 {
					...
					metrics.IncrCounterWithLabels([]string{"she", "migration", "nodes_imported"}, float32(1000000), []metrics.Label{
